...
public class MubbleBlocks extends MubblePack {
	...
	public static final Block NSMBU_EMPTY_BLOCK = register(new BlockCreator.Builder("nsmbu_empty_block", new EmptyBlock(MubbleSounds.BLOCK_EMPTY_BLOCK_HIT_NSMBU, Settings.QUESTION_BLOCK)).itemGroup(ItemGroup.BUILDING_BLOCKS));
	public static final Block SMB_QUESTION_BLOCK = register(new BlockCreator.Builder("smb_question_block", new LootablePunchBlock(SMB_EMPTY_BLOCK, MubbleSounds.BLOCK_LOOTABLE_PUNCH_BLOCK_LOOT_COIN_SMB, MubbleSounds.BLOCK_LOOTABLE_PUNCH_BLOCK_LOOT_SMB, Settings.QUESTION_BLOCK)).itemGroup(ItemGroup.BUILDING_BLOCKS));
	public static final Block SMB3_QUESTION_BLOCK = register(new BlockCreator.Builder("smb3_question_block", new LootablePunchBlock(SMB3_EMPTY_BLOCK, MubbleSounds.BLOCK_LOOTABLE_PUNCH_BLOCK_LOOT_COIN_SMB3, MubbleSounds.BLOCK_LOOTABLE_PUNCH_BLOCK_LOOT_SMB3, Settings.QUESTION_BLOCK)).itemGroup(ItemGroup.BUILDING_BLOCKS));
	public static final Block SMW_QUESTION_BLOCK = register(new BlockCreator.Builder("smw_question_block", new LootablePunchBlock(SMW_EMPTY_BLOCK, MubbleSounds.BLOCK_LOOTABLE_PUNCH_BLOCK_LOOT_COIN_SMW, MubbleSounds.BLOCK_LOOTABLE_PUNCH_BLOCK_LOOT_SMW, Settings.QUESTION_BLOCK)).itemGroup(ItemGroup.BUILDING_BLOCKS));
	public static final Block NSMBU_QUESTION_BLOCK = register(new BlockCreator.Builder("nsmbu_question_block", new LootablePunchBlock(NSMBU_EMPTY_BLOCK, MubbleSounds.BLOCK_LOOTABLE_PUNCH_BLOCK_LOOT_COIN_NSMBU, MubbleSounds.BLOCK_LOOTABLE_PUNCH_BLOCK_LOOT_NSMBU, Settings.QUESTION_BLOCK)).itemGroup(ItemGroup.BUILDING_BLOCKS));
	...
	public static final Block LIGHT_BLOCK = register(new BlockCreator.Builder("light_block", new Block(FabricBlockSettings.of(Material.STONE, MaterialColor.STONE).strength(1.5F, 6.0F).luminance(15))));
	public static final Block SMB_GROUND_BRICK_BLOCK = register(new BlockCreator.Builder("smb_ground_brick_block", new LootablePunchBlock(SMB_EMPTY_BLOCK, MubbleSounds.BLOCK_LOOTABLE_PUNCH_BLOCK_LOOT_COIN_SMB, MubbleSounds.BLOCK_LOOTABLE_PUNCH_BLOCK_LOOT_SMB, Settings.BRICK_BLOCK.sounds(MubbleSoundTypes.SMB_BRICK_BLOCK))).itemGroup(ItemGroup.BUILDING_BLOCKS));
	public static final Block SMB_UNDERGROUND_BRICK_BLOCK = register(new BlockCreator.Builder("smb_underground_brick_block", new LootablePunchBlock(SMB_EMPTY_BLOCK, MubbleSounds.BLOCK_LOOTABLE_PUNCH_BLOCK_LOOT_COIN_SMB, MubbleSounds.BLOCK_LOOTABLE_PUNCH_BLOCK_LOOT_SMB, Settings.BRICK_BLOCK.sounds(MubbleSoundTypes.SMB_BRICK_BLOCK))).itemGroup(ItemGroup.BUILDING_BLOCKS));
	public static final Block SMB_CASTLE_BRICK_BLOCK = register(new BlockCreator.Builder("smb_castle_brick_block", new LootablePunchBlock(SMB_EMPTY_BLOCK, MubbleSounds.BLOCK_LOOTABLE_PUNCH_BLOCK_LOOT_COIN_SMB, MubbleSounds.BLOCK_LOOTABLE_PUNCH_BLOCK_LOOT_SMB, Settings.BRICK_BLOCK.sounds(MubbleSoundTypes.SMB_BRICK_BLOCK))).itemGroup(ItemGroup.BUILDING_BLOCKS));
	public static final Block SMB_SNOW_BRICK_BLOCK = register(new BlockCreator.Builder("smb_snow_brick_block", new LootablePunchBlock(SMB_EMPTY_BLOCK, MubbleSounds.BLOCK_LOOTABLE_PUNCH_BLOCK_LOOT_COIN_SMB, MubbleSounds.BLOCK_LOOTABLE_PUNCH_BLOCK_LOOT_SMB, Settings.BRICK_BLOCK.sounds(MubbleSoundTypes.SMB_BRICK_BLOCK))).itemGroup(ItemGroup.BUILDING_BLOCKS));
	public static final Block SMB_NIGHT_SNOW_BRICK_BLOCK = register(new BlockCreator.Builder("smb_night_snow_brick_block", new LootablePunchBlock(SMB_EMPTY_BLOCK, MubbleSounds.BLOCK_LOOTABLE_PUNCH_BLOCK_LOOT_COIN_SMB, MubbleSounds.BLOCK_LOOTABLE_PUNCH_BLOCK_LOOT_SMB, Settings.BRICK_BLOCK.sounds(MubbleSoundTypes.SMB_BRICK_BLOCK))).itemGroup(ItemGroup.BUILDING_BLOCKS));
	public static final Block SMB3_BRICK_BLOCK = register(new BlockCreator.Builder("smb3_brick_block", new LootablePunchBlock(SMB3_EMPTY_BLOCK, MubbleSounds.BLOCK_LOOTABLE_PUNCH_BLOCK_LOOT_COIN_SMB3, MubbleSounds.BLOCK_LOOTABLE_PUNCH_BLOCK_LOOT_SMB3, Settings.BRICK_BLOCK.sounds(MubbleSoundTypes.SMB3_BRICK_BLOCK))).itemGroup(ItemGroup.BUILDING_BLOCKS));
	public static final Block SMW_BRICK_BLOCK = register(new BlockCreator.Builder("smw_brick_block", new LootablePunchBlock(SMW_EMPTY_BLOCK, MubbleSounds.BLOCK_LOOTABLE_PUNCH_BLOCK_LOOT_COIN_SMW, MubbleSounds.BLOCK_LOOTABLE_PUNCH_BLOCK_LOOT_SMW, Settings.BRICK_BLOCK.sounds(MubbleSoundTypes.SMW_BRICK_BLOCK))).itemGroup(ItemGroup.BUILDING_BLOCKS));
	public static final Block NSMBU_BRICK_BLOCK = register(new BlockCreator.Builder("nsmbu_brick_block", new LootablePunchBlock(NSMBU_EMPTY_BLOCK, MubbleSounds.BLOCK_LOOTABLE_PUNCH_BLOCK_LOOT_COIN_NSMBU, MubbleSounds.BLOCK_LOOTABLE_PUNCH_BLOCK_LOOT_NSMBU, Settings.BRICK_BLOCK.sounds(MubbleSoundTypes.NSMBU_BRICK_BLOCK))).itemGroup(ItemGroup.BUILDING_BLOCKS));
	public static final Block SMB_GOLDEN_BRICK_BLOCK = register(new BlockCreator.Builder("smb_golden_brick_block", new LootablePunchBlock(SMB_EMPTY_BLOCK, MubbleSounds.BLOCK_LOOTABLE_PUNCH_BLOCK_LOOT_COIN_SMB, MubbleSounds.BLOCK_LOOTABLE_PUNCH_BLOCK_LOOT_SMB, Settings.BRICK_BLOCK.sounds(MubbleSoundTypes.SMB_BRICK_BLOCK))).itemGroup(ItemGroup.BUILDING_BLOCKS));
	public static final Block SMB3_GOLDEN_BRICK_BLOCK = register(new BlockCreator.Builder("smb3_golden_brick_block", new LootablePunchBlock(SMB3_EMPTY_BLOCK, MubbleSounds.BLOCK_LOOTABLE_PUNCH_BLOCK_LOOT_COIN_SMB3, MubbleSounds.BLOCK_LOOTABLE_PUNCH_BLOCK_LOOT_SMB3, Settings.BRICK_BLOCK.sounds(MubbleSoundTypes.SMB3_BRICK_BLOCK))).itemGroup(ItemGroup.BUILDING_BLOCKS));
	public static final Block SMW_GOLDEN_BRICK_BLOCK = register(new BlockCreator.Builder("smw_golden_brick_block", new LootablePunchBlock(SMW_EMPTY_BLOCK, MubbleSounds.BLOCK_LOOTABLE_PUNCH_BLOCK_LOOT_COIN_SMW, MubbleSounds.BLOCK_LOOTABLE_PUNCH_BLOCK_LOOT_SMW, Settings.BRICK_BLOCK.sounds(MubbleSoundTypes.SMW_BRICK_BLOCK))).itemGroup(ItemGroup.BUILDING_BLOCKS));
	public static final Block NSMBU_GOLDEN_BRICK_BLOCK = register(new BlockCreator.Builder("nsmbu_golden_brick_block", new LootablePunchBlock(NSMBU_EMPTY_BLOCK, MubbleSounds.BLOCK_LOOTABLE_PUNCH_BLOCK_LOOT_COIN_NSMBU, MubbleSounds.BLOCK_LOOTABLE_PUNCH_BLOCK_LOOT_NSMBU, Settings.BRICK_BLOCK.sounds(MubbleSoundTypes.NSMBU_BRICK_BLOCK))).itemGroup(ItemGroup.BUILDING_BLOCKS));
	public static final BlockEntityType<LootablePunchBlockEntity> LOOTABLE_PUNCH_BLOCK_ENTITY = register(new BlockEntityCreator.Builder<>("lootable_punch_block", BlockEntityType.Builder.create(LootablePunchBlockEntity::new,
			SMB_QUESTION_BLOCK, SMB3_QUESTION_BLOCK, SMW_QUESTION_BLOCK, NSMBU_QUESTION_BLOCK,
			SMB_GROUND_BRICK_BLOCK, SMB_UNDERGROUND_BRICK_BLOCK, SMB_CASTLE_BRICK_BLOCK, SMB_SNOW_BRICK_BLOCK, SMB_NIGHT_SNOW_BRICK_BLOCK, SMB3_BRICK_BLOCK, SMW_BRICK_BLOCK, NSMBU_BRICK_BLOCK,
			SMB_GOLDEN_BRICK_BLOCK, SMB3_GOLDEN_BRICK_BLOCK, SMW_GOLDEN_BRICK_BLOCK, NSMBU_GOLDEN_BRICK_BLOCK
	)));
	...
	public static final Block SMB_NOTE_BLOCK = register(new BlockCreator.Builder("smb_note_block", new NoteBlock(MubbleSounds.BLOCK_NOTE_BLOCK_JUMP_SMB, FabricBlockSettings.copy(Blocks.STONE))).itemGroup(ItemGroup.BUILDING_BLOCKS));
	public static final Block SMB3_NOTE_BLOCK = register(new BlockCreator.Builder("smb3_note_block", new NoteBlock(MubbleSounds.BLOCK_NOTE_BLOCK_JUMP_SMB3, FabricBlockSettings.copy(Blocks.STONE))).itemGroup(ItemGroup.BUILDING_BLOCKS));
	public static final Block SMW_NOTE_BLOCK = register(new BlockCreator.Builder("smw_note_block", new NoteBlock(MubbleSounds.BLOCK_NOTE_BLOCK_JUMP_SMW, FabricBlockSettings.copy(Blocks.STONE))).itemGroup(ItemGroup.BUILDING_BLOCKS));
	public static final Block NSMBU_NOTE_BLOCK = register(new BlockCreator.Builder("nsmbu_note_block", new NoteBlock(MubbleSounds.BLOCK_NOTE_BLOCK_JUMP_LOW_NSMBU, MubbleSounds.BLOCK_NOTE_BLOCK_JUMP_HIGH_NSMBU, FabricBlockSettings.copy(Blocks.STONE))).itemGroup(ItemGroup.BUILDING_BLOCKS));
	public static final Block SMB_SUPER_NOTE_BLOCK = register(new BlockCreator.Builder("smb_super_note_block", new SuperNoteBlock(MubbleSounds.BLOCK_NOTE_BLOCK_JUMP_SMB, FabricBlockSettings.copy(Blocks.STONE))).itemGroup(ItemGroup.BUILDING_BLOCKS));
	public static final Block SMB3_SUPER_NOTE_BLOCK = register(new BlockCreator.Builder("smb3_super_note_block", new SuperNoteBlock(MubbleSounds.BLOCK_NOTE_BLOCK_JUMP_SMB3, FabricBlockSettings.copy(Blocks.STONE))).itemGroup(ItemGroup.BUILDING_BLOCKS));
	public static final Block SMW_SUPER_NOTE_BLOCK = register(new BlockCreator.Builder("smw_super_note_block", new SuperNoteBlock(MubbleSounds.BLOCK_NOTE_BLOCK_JUMP_SMW, FabricBlockSettings.copy(Blocks.STONE))).itemGroup(ItemGroup.BUILDING_BLOCKS));
	public static final Block NSMBU_SUPER_NOTE_BLOCK = register(new BlockCreator.Builder("nsmbu_super_note_block", new SuperNoteBlock(MubbleSounds.BLOCK_NOTE_BLOCK_JUMP_LOW_NSMBU, MubbleSounds.BLOCK_NOTE_BLOCK_JUMP_HIGH_NSMBU, FabricBlockSettings.copy(Blocks.STONE))).itemGroup(ItemGroup.BUILDING_BLOCKS));
	...
	public static final PottedPlantPack GOLD_FLOWER = register(new PottedPlantPack.Builder(new BlockCreator.Builder("gold_flower", new FlowerBlock(StatusEffects.GLOWING, 6, FabricBlockSettings.of(Material.PLANT).noCollision().hardness(0.0F).sounds(BlockSoundGroup.GRASS).luminance(5))).itemGroup(ItemGroup.DECORATIONS).flammability(60, 100).render(BlockCreator.Render.CUTOUT)));
	/* KIRBY */
	...
	public static final Block GREEN_HILL_GRASS_BLOCK = register(new BlockCreator.Builder("green_hill_grass_block", new GrassBlock(GREEN_HILL_DIRT, FabricBlockSettings.copy(Blocks.GRASS_BLOCK))).itemGroup(ItemGroup.BUILDING_BLOCKS).render(BlockCreator.Render.CUTOUT_MIPPED));
	...
	public static final PottedPlantPack SCARLET_MUSHROOM = register(new PottedPlantPack.Builder(new BlockCreator.Builder("scarlet_mushroom", new MushroomPlantBlock(FabricBlockSettings.of(Material.PLANT).noCollision().hardness(0.0F).sounds(BlockSoundGroup.GRASS).luminance(7))).itemGroup(ItemGroup.DECORATIONS).render(BlockCreator.Render.CUTOUT)));
	public static final PottedPlantPack SCARLET_ORCHID = register(new PottedPlantPack.Builder(new BlockCreator.Builder("scarlet_orchid", new FlowerBlock(StatusEffects.GLOWING, 8, FabricBlockSettings.of(Material.PLANT).noCollision().hardness(0.0F).sounds(BlockSoundGroup.GRASS).luminance(7))).itemGroup(ItemGroup.DECORATIONS).flammability(60, 100).render(BlockCreator.Render.CUTOUT)));
	/* CELESTE */
	...
	public static final Block ELDER_PEBBLES = register(new BlockCreator.Builder("elder_pebbles", new Block(FabricBlockSettings.of(Material.STONE, MaterialColor.RED).strength(2.0F, 6.0F).luminance(5))).itemGroup(ItemGroup.BUILDING_BLOCKS));
	...
	public static final Block POINT_PUYO = register(new BlockCreator.Builder("point_puyo", new DirectionalBlock(FabricBlockSettings.of(Material.STONE, MaterialColor.STONE).strength(1.5F, 6.0F).luminance(10))).noItem());
	...
	public static class Settings {
		...
		public static final FabricBlockSettings BRICK_BLOCK = FabricBlockSettings.of(Material.STONE, MaterialColor.RED).strength(2.0F, 6.0F);
